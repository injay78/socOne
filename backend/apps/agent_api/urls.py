...
from .views import (
    ...
    IntelVerifyView,
    CMDBLookupView,
    NotificationSendAgentView,
    NotificationTestAgentView,
    QRadarOffenseDetailView,
    QRadarOffenseListView,
    SIEMQRadarSearchView,
    TrellixDetectionDetailView,
    TrellixDetectionListView,
    TrellixHostView,
    TrellixSearchView,
    DevStreamHeadView,
    DevStreamReadView,
...
urlpatterns = [
    ...
    path("notifications/test/", NotificationTestAgentView.as_view(), name="agent-api-notification-test"),
    path("notifications/send/", NotificationSendAgentView.as_view(), name="agent-api-notification-send"),
    ...
    path("cases/<str:case_id>/triage/", CaseTriageView.as_view(), name="agent-api-case-triage"),
    ...
    path("intel/verify/", IntelVerifyView.as_view(), name="agent-api-intel-verify"),
    ...
    path("siem/qradar/search/", SIEMQRadarSearchView.as_view(), name="agent-api-siem-qradar-search"),
    path("siem/qradar/offenses/", QRadarOffenseListView.as_view(), name="agent-api-siem-qradar-offenses"),
    path("siem/qradar/offenses/<str:offense_id>/", QRadarOffenseDetailView.as_view(), name="agent-api-siem-qradar-offense"),
    path("edr/trellix/detections/", TrellixDetectionListView.as_view(), name="agent-api-edr-trellix-detections"),
    path("edr/trellix/detections/<str:detection_id>/", TrellixDetectionDetailView.as_view(), name="agent-api-edr-trellix-detection"),
    path("edr/trellix/hosts/", TrellixHostView.as_view(), name="agent-api-edr-trellix-hosts"),
    path("edr/trellix/search/", TrellixSearchView.as_view(), name="agent-api-edr-trellix-search"),
